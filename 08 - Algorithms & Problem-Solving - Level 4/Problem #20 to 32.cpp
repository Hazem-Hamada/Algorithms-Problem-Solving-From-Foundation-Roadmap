...
short ReadDay() { short Day; cout << "\nPlease enter a Day? "; cin >> Day; return Day; }
short ReadMonth() { short Month; cout << "Please enter a Month? "; cin >> Month; return Month; }
short ReadYear() { short Year; cout << "Please enter a Year? "; cin >> Year; return Year; }
...
int main()
{
    ...
    Date1 = IncreaseDateByOneDay(Date1); // Logic
    cout << "\n01-Adding one day is: " << Date1.Day << "/" << Date1.Month << "/" << Date1.Year; // UI
